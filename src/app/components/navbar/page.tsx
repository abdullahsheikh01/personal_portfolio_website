  ...
  return (
    <header>
      ...
      lap:hidden lmd:hidden">
        <li><Link href="\" className="hover:text-blue-700 font-roboto font-medium">Home</Link></li>
        <li><Link href="/components/about_me" className="hover:text-blue-700 font-roboto font-medium">About Me</Link></li>
        <li><Link href="/components/my_skills" className="hover:text-blue-700 font-roboto font-medium">My Skills</Link></li>
        <li><Link href="/components/my_work" className="hover:text-blue-700 font-roboto font-medium">My Work</Link></li>
        ...
        <li><Link href="/components/contact_me" className="hover:text-blue-700 font-roboto font-medium">Contact Me</Link></li>
      </ul>
